...
checkout. Изменение статуса оплаты, `paid_at` и финансовых реквизитов будет доступно только через
отдельную защищённую операцию TASK-067 — публичных маршрутов для этого нет.
