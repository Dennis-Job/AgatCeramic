...
Конкретный storage provider, KMS, retention и ответственные утверждаются до production launch.
...
7. Переключать production на восстановленную БД можно только в согласованное окно, после отдельного
   approval и с проверенным rollback plan.
8. Удалить временный расшифрованный архив и отозвать выданный доступ.
