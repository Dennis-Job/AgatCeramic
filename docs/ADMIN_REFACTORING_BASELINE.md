# Исторический baseline Admin перед рефакторингом

> **Статус:** исторический baseline. Указанные ниже пути, количества и результаты тестов
> зафиксированы на даты соответствующих проверок и не являются текущими метриками. Актуальное
> состояние описано в [`CURRENT_STATE.md`](CURRENT_STATE.md), действующие проверки — в
> [`CI.md`](CI.md).
