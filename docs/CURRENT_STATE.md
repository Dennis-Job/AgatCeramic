...
| --- | --- | --- |
| 7 — Content | Site settings (`TASK-090`), pages (`TASK-091`), banners (`TASK-092`) и sliders (`TASK-093`) готовы; stores, working hours и managed Media Library ещё не реализованы. | Media заменит Catalog placeholders `categories.image_id` и `brands.logo_id`, а также внешние URL изображений баннеров. |
