...
`type=email`, нормализованные имя, email и сообщение. В обоих случаях `source=website`; клиент не
может передать тип или источник. Статус, ответственный, комментарии и история обработки добавляются
последующими задачами Phase 6.
