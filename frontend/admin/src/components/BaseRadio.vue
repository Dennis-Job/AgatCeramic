...
<template>
  <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-100 p-3 text-sm text-gray-600 transition hover:border-primary-200 hover:bg-primary-25 focus-within:border-primary-500 focus-within:ring-4 focus-within:ring-primary-50" :class="{ 'border-primary-500 bg-primary-50 text-primary-600': modelValue === value }">
