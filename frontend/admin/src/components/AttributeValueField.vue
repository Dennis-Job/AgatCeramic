...
<template>
  ...
  <BaseSelect v-else-if="attribute.type === 'select'" :model-value="stringValue" :options="options" :required="required" :accessible-name="label" :clearable="clearable" teleport-menu @update:model-value="emit('update:modelValue', $event)" />
