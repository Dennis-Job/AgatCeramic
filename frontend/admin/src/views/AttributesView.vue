...
function open(attribute: Attribute | null = null): void {
  opened.value = false; dialogError.value = ''; dialogOpener.value = document.activeElement instanceof HTMLElement ? document.activeElement : null; editing.value = attribute; manuallyEditedSlug.value = attribute !== null
