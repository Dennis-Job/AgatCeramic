...
- [ ] TASK-A001 Зафиксировать исходное состояние и карту реализации Phases 0–6
...
- [ ] TASK-A002 Провести повторную приёмку Phases 0–6
...
- [ ] TASK-A003 Утвердить информационную архитектуру и единый стиль документации
